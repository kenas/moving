		...
		<div class="row">
			<div class="col-sm-5 col-md-5 col-lg-5">
				...
				<h1>Kontakt</h1>
					...
					<blockquote>
						Curabitur vitae diam non enim vestibulum interdum. Fusce consectetuer risus a nunc. Sed convallis magna eu sem. Nullam dapibus fermentum ipsum. Duis pulvinar. Sed convallis magna eu sem. Curabitur sagittis hendrerit ante. Sed elit dui, pellentesque a, faucibus vel, interdum nec, diam. Nulla non lectus sed nisl molestie malesuada. Curabitur ligula sapien, pulvinar a vestibulum quis, facilisis vel sapien. Cras pede libero, dapibus nec, pretium sit amet, tempor quis. Etiam posuere lacus quis dolor. Phasellus enim erat, vestibulum vel, aliquam a, posuere eu, velit. Fusce wisi.
					</blockquote>	
			</div>
			...
			<div class="col-sm-7 col-md-7 col-lg-7">
				...
				<form action="{{route('sendEmail')}}" method="POST">
					...
					<input type="text" v-model="subject" name="subject" class="form-control form-control-lg" placeholder="Predmet">

					<label for="email"></label>
					<input type="email" v-model="email" name="email" class="form-control form-control-lg" placeholder="Email">
