			...
			<div class="card">
				...
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item"><a
							href="{{route('articles.show', ['kategorie' => strtolower($category->slug), 'clanek' => $article->slug])}}">{{ $article->title }}</a>
					</li>
					@endforeach
				</ul>
				<div class="card-body">
					<a href="{{ route('category.index', strtolower($category->name)) }}" class="card-link">Přejít do
						této kategorie</a>
